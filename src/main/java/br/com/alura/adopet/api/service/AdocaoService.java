...
public class AdocaoService {
    ...
    @Autowired
    private List<ValidacaoSolicitacaoAdocao> validacoes; //Aqui ele vai injetar todas as classes dessa validacao
    ...
    public void solicitar(SolicitacaoAdocaoDto dto){
        ...
        validacoes.forEach( v -> v.validar(dto)); //Percorerá cada validador da lista
